...
const features = [
  "Healthy & Premium Quality Plants",
  "Professional Plant Consultation",
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-6 lg:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-8 text-lg leading-8 text-gray-300">
            BioPlant Project adalah perusahaan yang bergerak di bidang
            tanaman hias dan solusi penghijauan. Kami menyediakan
            berbagai koleksi tanaman indoor, outdoor, serta layanan
            konsultasi dan penataan tanaman untuk rumah, kantor,
