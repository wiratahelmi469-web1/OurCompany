      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <h2 className="mt-4 text-4xl font-bold text-white md:text-5xl">
            Bringing Nature Into Every Space
          </h2>
          ...
          <div className="relative h-[650px]">
            ...
            <div className="absolute bottom-0 left-0 p-10 md:p-16">
              ...
              <h3 className="mt-6 text-4xl font-bold text-white md:text-5xl">
                Explore Our Green Journey
              </h3>

              <p className="mt-6 max-w-2xl text-lg leading-8 text-gray-200">
                Setiap tanaman memiliki cerita. Kami percaya ruang hijau
                mampu menghadirkan kenyamanan, kesejukan, dan inspirasi
                bagi setiap orang.
              </p>
