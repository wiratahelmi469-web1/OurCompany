...
import { galleryFaq } from "@/app/data/gallery";
      ...
      <div className="mx-auto max-w-4xl px-6">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-300">
            Berikut beberapa pertanyaan yang sering diajukan mengenai
            galeri, nursery, dan layanan BioPlant Project.
          </p>
