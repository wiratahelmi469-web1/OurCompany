      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid gap-8 md:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="rounded-3xl bg-[#132A22] p-8 text-center transition hover:-translate-y-2">
            ...
            <h3 className="mt-6 text-2xl font-bold text-white">Alamat</h3>
          ...
          <div className="rounded-3xl bg-[#132A22] p-8 text-center transition hover:-translate-y-2">
            ...
            <h3 className="mt-6 text-2xl font-bold text-white">Telepon</h3>

            <p className="mt-4 text-gray-300">{contactInfo.phone}</p>
          </div>
          ...
          <div className="rounded-3xl bg-[#132A22] p-8 text-center transition hover:-translate-y-2">
            ...
            <p className="mt-4 text-gray-300 break-all">{contactInfo.email}</p>
          </div>
          ...
          <div className="rounded-3xl bg-[#132A22] p-8 text-center transition hover:-translate-y-2">
            ...
            <p className="mt-4 text-gray-300">Monday - Saturday</p>

            <p className="text-green-400">08:00 - 17:00</p>
          </div>
        </div>
      </div>
    </section>
