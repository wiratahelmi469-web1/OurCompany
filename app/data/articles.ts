...
export const articleFaq = [
  {
    question: "Apakah semua artikel BioPlant dapat dibaca secara gratis?",
    answer:
      "Ya. Semua artikel yang kami publikasikan dapat diakses secara gratis sebagai bentuk edukasi bagi pecinta tanaman.",
  },
  {
    question: "Seberapa sering artikel baru diterbitkan?",
    answer:
      "Kami berusaha memperbarui artikel secara rutin dengan topik terbaru mengenai tanaman hias, landscape, dan tips perawatan.",
  },
  {
    question: "Apakah saya bisa mengusulkan topik artikel?",
    answer:
      "Tentu. Anda dapat menghubungi tim BioPlant melalui halaman Contact untuk memberikan saran topik yang ingin dibahas.",
  },
  {
    question: "Bagaimana cara mendapatkan notifikasi artikel terbaru?",
    answer:
      "Anda dapat berlangganan Newsletter BioPlant agar mendapatkan informasi artikel terbaru langsung melalui email.",
  },
];
